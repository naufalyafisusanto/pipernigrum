                            ...
                            <div class="form-group">
                                ...
                                <div class="form-row p-2" style="border:1px solid #ced4da; border-radius: 0.25rem; margin: 0 0.7px;">    
                                    <div class="form-group col-md-4 col-sm-4 col-4 mb-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control params params-input params-int" id="set-temperature-fast" name="set-temperature-fast" placeholder={{ $params['set-temperature-fast'] }} value={{ $params['set-temperature-fast'] }} min="55.0" max="75.0">
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group col-md-4 col-sm-4 col-4 mb-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control params params-input params-int" id="set-temperature-medium" name="set-temperature-medium" placeholder={{ $params['set-temperature-medium'] }} value={{ $params['set-temperature-medium'] }} min="55.0" max="75.0">
                                            <div class="input-group-append">
                                                <div class="input-group-text" style="width: 45px;padding: 10px 0px;justify-content: center; border-top-right-radius: .25rem; border-bottom-right-radius: .25rem;">&deg;C</div>
                                            </div>
                                            <div class="invalid-feedback" style="font-size: 13px"></div>
                                    ...
                                    <div class="form-group col-md-4 col-sm-4 col-4 mb-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control params params-input params-int" id="set-temperature-low" name="set-temperature-low" placeholder={{ $params['set-temperature-low'] }} value={{ $params['set-temperature-low'] }} min="55.0" max="75.0">
                                            <div class="input-group-append">
                                                <div class="input-group-text" style="width: 45px;padding: 10px 0px;justify-content: center; border-top-right-radius: .25rem; border-bottom-right-radius: .25rem;">&deg;C</div>
                                            </div>
                                            <div class="invalid-feedback" style="font-size: 13px"></div>
